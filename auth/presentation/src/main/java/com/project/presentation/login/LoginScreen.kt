...
fun LoginScreen(
    ...
    GradientBackground {
        Column(
            ...
            Text(
                text = stringResource(id = com.project.presentation.R.string.hi_there),
                fontWeight = FontWeight.SemiBold,
                style = MaterialTheme.typography.headlineMedium
            )
            Text(
                text = stringResource(id = com.project.presentation.R.string.runique_welcome_text),
                fontSize = 12.sp,
            ...
            RuniqueActionButton(
                text = stringResource(id = com.project.presentation.R.string.login),
            ...
            val annotatedString = buildAnnotatedString {
                withStyle(
                    ...
                    append(stringResource(id = com.project.presentation.R.string.dont_have_an_account) + " ")
                    pushStringAnnotation(
                        tag = "clickable_text",
                        annotation = stringResource(id = com.project.presentation.R.string.sign_up)
                    )
                    withStyle(
                        style = SpanStyle(
                            fontWeight = FontWeight.SemiBold,
                        ...
                        append(stringResource(id = com.project.presentation.R.string.sign_up))
                    }
                }
            }
            Box(
